import{r,j as a,$ as S,k as n,i as j}from"./index-CBii5nT_.js";import{B as b}from"./button-D5EtV_15.js";import{T as k}from"./textarea-DPrpfUho.js";import{B as A}from"./badge-CVING9jG.js";import{R as I}from"./refresh-cw-DjBw-LWG.js";import{C as R}from"./check-check-Dh017Y00.js";import{C as O}from"./copy-C-XQu9Lr.js";import{S as P}from"./send-CNP00I63.js";const T=["Crie uma legenda para Instagram sobre produção audiovisual","Faça um roteiro de 60 segundos para apresentação de empresa","Sugira 5 ideias de conteúdo para uma marca de moda","Redija um email de proposta comercial para cliente novo","Liste os diferenciais de uma produtora audiovisual premium"],N={default:"Olá! Sou a Nova, sua assistente inteligente da INOVA Co. Estou aqui para ajudar com roteiros, legendas, estratégias de conteúdo, propostas comerciais e muito mais. Como posso te ajudar hoje? 🚀"};function F(){const[d,l]=r.useState([{id:"0",role:"assistant",content:N.default}]),[c,x]=r.useState(""),[m,f]=r.useState(!1),[C,g]=r.useState(null),h=r.useRef(null);r.useEffect(()=>{var e;(e=h.current)==null||e.scrollIntoView({behavior:"smooth"})},[d]);const w=async e=>{var t,i,o,v,y;const s="AIzaSyCpNWmfOR7JZm6wK9gkuySyE8NIjslTpWY";try{return((y=(v=(o=(i=(t=(await(await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=${s}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:`Você é a Nova, assistente da INOVA Co., uma produtora audiovisual premium. Responda em português brasileiro de forma profissional e criativa.
