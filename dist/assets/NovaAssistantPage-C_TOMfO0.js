import{r,j as a,$ as S,k as n,i as j}from"./index-B_wBLAX8.js";import{B as b}from"./button-D1xiY3mj.js";import{T as A}from"./textarea-JlaS61SD.js";import{B as k}from"./badge-BmZ4FHNe.js";import{R}from"./refresh-cw-CJtipDAI.js";import{C as I}from"./check-check-C9Gwm3qY.js";import{C as P}from"./copy-DvLt3NzQ.js";import{S as O}from"./send-qt47kj-3.js";const z=["Crie uma legenda para Instagram sobre produção audiovisual","Faça um roteiro de 60 segundos para apresentação de empresa","Sugira 5 ideias de conteúdo para uma marca de moda","Redija um email de proposta comercial para cliente novo","Liste os diferenciais de uma produtora audiovisual premium"],N={default:"Olá! Sou a Nova, sua assistente inteligente da INOVA Co. Estou aqui para ajudar com roteiros, legendas, estratégias de conteúdo, propostas comerciais e muito mais. Como posso te ajudar hoje? 🚀"};function F(){const[d,l]=r.useState([{id:"0",role:"assistant",content:N.default}]),[c,x]=r.useState(""),[m,f]=r.useState(!1),[w,g]=r.useState(null),h=r.useRef(null);r.useEffect(()=>{var e;(e=h.current)==null||e.scrollIntoView({behavior:"smooth"})},[d]);const C=async e=>{var t,i,o,v,y;const s="AIzaSyCNw7zWj3AAhnOwvAYQPW6XNZoR_QY7KtE";try{return((y=(v=(o=(i=(t=(await(await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-flash-latest:generateContent?key=${s}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:`Você é a Nova, assistente da INOVA Co., uma produtora audiovisual premium. Responda em português brasileiro de forma profissional e criativa.
...
Faça uma pergunta mais específica para eu criar o conteúdo perfeito para você!`},p=async e=>{const s=e||c.trim();if(!s||m)return;x("");const t={id:crypto.randomUUID(),role:"user",content:s};l(o=>[...o,t]),f(!0);const i=await C(s);l(o=>[...o,{id:crypto.randomUUID(),role:"assistant",content:i}]),f(!1)},E=(e,s)=>{navigator.clipboard.writeText(s),g(e),setTimeout(()=>g(null),2e3)};return a.jsxs("div",{className:"flex flex-col h-[calc(100vh-8rem)] space-y-0",children:[a.jsxs("div",{className:"flex items-center justify-between mb-4",children:[a.jsxs("div",{children:[a.jsxs("h1",{className:"text-2xl font-bold text-foreground flex items-center gap-2",children:[a.jsx(S,{className:"h-6 w-6 text-primary"})," Nova Assistente ",a.jsx(k,{className:"bg-primary/10 text-primary border-primary/30 text-xs",children:"IA"})]}),a.jsx("p",{className:"text-muted-foreground text-sm mt-1",children:"Sua assistente criativa para conteúdo e comunicação"})]}),a.jsxs(b,{variant:"outline",size:"sm",onClick:()=>l([{id:"0",role:"assistant",content:N.default}]),className:"flex items-center gap-2",children:[a.jsx(R,{className:"h-3.5 w-3.5"})," Nova conversa"]})]}),a.jsxs("div",{className:"flex-1 rounded-xl border border-border bg-card overflow-hidden flex flex-col",children:[a.jsxs("div",{className:"flex-1 overflow-y-auto p-4 space-y-4",children:[d.map(e=>a.jsxs("div",{className:n("flex gap-3",e.role==="user"&&"flex-row-reverse"),children:[a.jsx("div",{className:n("h-8 w-8 rounded-full flex items-center justify-center flex-shrink-0 text-sm",e.role==="assistant"?"bg-primary/20 text-primary":"bg-secondary text-foreground"),children:e.role==="assistant"?a.jsx(j,{className:"h-4 w-4"}):"👤"}),a.jsx("div",{className:n("max-w-[75%] group",e.role==="user"&&"items-end flex flex-col"),children:a.jsxs("div",{className:n("px-4 py-3 rounded-xl text-sm whitespace-pre-line leading-relaxed relative",e.role==="assistant"?"bg-secondary text-foreground rounded-tl-sm":"bg-primary text-primary-foreground rounded-tr-sm"),children:[e.content,e.role==="assistant"&&a.jsx("button",{onClick:()=>E(e.id,e.content),className:"absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded hover:bg-black/10",children:w===e.id?a.jsx(I,{className:"h-3.5 w-3.5 text-primary"}):a.jsx(P,{className:"h-3.5 w-3.5 text-muted-foreground"})})]})})]},e.id)),m&&a.jsxs("div",{className:"flex gap-3",children:[a.jsx("div",{className:"h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0",children:a.jsx(j,{className:"h-4 w-4 text-primary animate-pulse"})}),a.jsxs("div",{className:"bg-secondary rounded-xl px-4 py-3 flex items-center gap-1",children:[a.jsx("span",{className:"h-2 w-2 rounded-full bg-primary animate-bounce",style:{animationDelay:"0ms"}}),a.jsx("span",{className:"h-2 w-2 rounded-full bg-primary animate-bounce",style:{animationDelay:"150ms"}}),a.jsx("span",{className:"h-2 w-2 rounded-full bg-primary animate-bounce",style:{animationDelay:"300ms"}})]})]}),a.jsx("div",{ref:h})]}),d.length<=1&&a.jsx("div",{className:"px-4 pb-2 flex gap-2 overflow-x-auto",children:z.map((e,s)=>a.jsx("button",{onClick:()=>p(e),className:"flex-shrink-0 text-xs px-3 py-1.5 rounded-full border border-border text-muted-foreground hover:border-primary/50 hover:text-primary transition-colors bg-card",children:e},s))}),a.jsxs("div",{className:"p-3 border-t border-border flex gap-2",children:[a.jsx(A,{value:c,onChange:e=>x(e.target.value),onKeyDown:e=>{e.key==="Enter"&&!e.shiftKey&&(e.preventDefault(),p())},placeholder:"Peça um roteiro, legenda, ideia de conteúdo... (Enter para enviar)",className:"flex-1 min-h-[52px] max-h-32 resize-none"}),a.jsx(b,{onClick:()=>p(),disabled:m||!c.trim(),size:"icon",className:"self-end h-10 w-10",children:a.jsx(O,{className:"h-4 w-4"})})]})]})]})}export{F as default};
