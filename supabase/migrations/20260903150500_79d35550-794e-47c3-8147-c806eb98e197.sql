-- =========================================================
-- CORREÇÃO: falha ao assinar contrato
-- A migração 20260903144758 sobrescreveu a função
-- auto_create_client_on_signature inserindo ARRAY[]::text[]
-- na coluna account_manager, que é do tipo TEXT (não text[]).
-- Isso lança erro de tipo no trigger AFTER INSERT, revertendo
-- o INSERT da assinatura e exibindo "Erro ao assinar o contrato".
-- Recriamos a função com a versão correta (case_managername
-- como string vazia e service_type como array).
-- =========================================================
